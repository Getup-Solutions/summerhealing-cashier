        ...
        <template #body>
            <div class="grid md:grid-cols-2 gap-6 gap-y-4">
                <div class="col-span-2 grid md:grid-cols-2 gap-6 gap-y-4">
                    ...
                    <div class=" col-span-2">
                        <FormFileUploadSingle @fileChange="(file) => (sessionInfo.thumbnail = file[0])" :label="'Thumbnail'"
                            :oldImageLink="session.thumbnail_url" :rounded="false" :name="'thumbnail'" :hideInputBox="true"
            ...
            <div id="accordion-flush" data-accordion="collapse"
                            ...
                            <li v-for="subscriptionplan in subscriptionplansPrices" :key="subscriptionplan">
                                ...
                                <label :for="`react-option-${subscriptionplan.slug}`"
                                    ...
                                    <div class="block bg-white/80 dark:bg-black/70 rounded p-4 w-full">
                                        ...
                                        <div class="w-full text-lg font-semibold mb-2">{{ subscriptionplan.title }}</div>
                ...
                <h2 id="accordion-flush-heading-3">
                    <button type="button"
                        ...
                        <label for="" class="block mb-2 text-sm font-medium text-blue-500 dark:text-blue-400">Pricing</label>
                        <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 5 5 1 1 5" />
                ...
                <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                    <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                        <ul class="grid w-full gap-6 md:grid-cols-2">
                            ...
                            <li v-for="subscriptionplan, index in  selectedSubscriptionplansWithPrice" :key="subscriptionplan.id">
...
export default {
props: ["errors","session", "agegroups", "levels", "trainers", "subscriptionplansPrices","subscriptionplansSelected","trainersSelected"],
data() {
    return {
