                    ...
                    <div class="col-span-2 grid md:grid-cols-2 gap-6 gap-y-4">
                        ...
                        <div class=" col-span-2">
                            <FormFileUploadSingle @fileChange="(file) => (sessionInfo.thumbnail = file[0])"
                                :label="'Thumbnail'" :oldImageLink="session.thumbnail_url" :rounded="false"
                    ...
                    <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            <ul class="grid w-full gap-6 md:grid-cols-2">
                                <li v-for="subscriptionplan in subscriptionplansPrices" :key="subscriptionplan">
                                    <input type="checkbox" :id="`react-option-${subscriptionplan.slug}`"
                                        class="hidden peer/subscriptionplan" :value="subscriptionplan.id"
                                        v-model="sessionInfo.subscriptionplansSelected" required="">
                                    <label :for="`react-option-${subscriptionplan.slug}`"
                                        :style="`background-image: url(${subscriptionplan.thumbnail_url});`"
                                        class="bg-center bg-contain inline-flex items-center p-3 justify-between w-full text-gray-900 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:hover:text-white dark:border-gray-700 peer-checked/subscriptionplan:border-blue-600 peer-checked/subscriptionplan:shadow-xl peer-checked/subscriptionplan:shadow-blue-800 hover:text-gray-800 dark:peer-checked/subscriptionplan:text-white peer-checked/subscriptionplan:text-gray-900 hover:bg-gray-50 dark:text-white dark:bg-gray-800 dark:hover:bg-gray-700">
                                        <div class="block bg-white/80 dark:bg-black/70 rounded p-4 w-full">
                                            ...
                                            <div class="w-full text-lg font-semibold mb-2">{{ subscriptionplan.title }}
                                            </div>
                                            <div class="w-full text-xs"><span class="font-semibold">Validity :</span> {{
                                                subscriptionplan.validity }} days</div>
                    ...
                    <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            <ul class="grid w-full gap-6 md:grid-cols-2">
                                ...
                                <li v-for="subscriptionplan, index in  selectedSubscriptionplansWithPrice"
                                    :key="subscriptionplan.id">
                                    <FormSimpleInput :label="'Price for - ' + subscriptionplan.title + ' subscriptionplan'"
                                        :name="subscriptionplan.title" :type="'number'"
...
<script>
export default {
    props: ["errors", "session", "agegroups", "levels", "trainers", "subscriptionplansPrices", "subscriptionplansSelected", "trainersSelected", "days", "schedule", "daysSelectedData", "daysEventData"],
    data() {
        return {
