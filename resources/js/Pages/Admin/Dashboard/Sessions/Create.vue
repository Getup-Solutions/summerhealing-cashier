<template>
    <!-- Modal content -->
    <Modal :modalHeadingText="'Create new session'" :modalHeadingResetButton="true" :modalWidth="2">
        <template #body>
                ...
                <div class="col-span-2 grid md:grid-cols-2 gap-6 gap-y-4">
                    ...
                    <div class=" col-span-2">
                        <FormFileUploadSingle @fileChange="(file) => (sessionInfo.thumbnail = file[0])" :label="'Thumbnail'"
                            :oldImageLink="''" :rounded="false" :name="'thumbnail'" :hideInputBox="true"
        ...
        <template #footer>
            <Button
                ...
                :text="'Create session'" :color="'blue'"></Button>
        </template>
    </Modal>
</template>
<script>
