                        ...
                        <ul class="grid w-full md:grid-cols-2 gap-6">
                            <li v-for="trainer in trainers" :key="trainer">
                                <input type="checkbox" :id="`react-option-${trainer.id}`" class="hidden peer/trainer"
                                    :value="trainer.id" v-model="facilityInfo.trainers" required="">
                        ...
                        <ul class="grid w-full gap-6 md:grid-cols-2">
                            <li v-for="subscriptionplan in subscriptionplansPrices" :key="subscriptionplan">
                                <input type="checkbox" :id="`react-option-${subscriptionplan.slug}`"
                                    ...
                                    v-model="facilityInfo.subscriptionplansSelected" required="">
...
export default {
    props: ["errors", "facility", "trainers", "subscriptionplansPrices", "subscriptionplansSelected", "trainersSelected"],
    data() {
        return {
    ...
    computed: {
        selectedSubscriptionplansWithPrice() {
            var selectedSubscriptionplan = this.subscriptionplansPrices.filter((item) => this.facilityInfo.subscriptionplansSelected.includes(item.id));
        ...
        //         return item;
        //     });
        //     // var newArr = selectedSubscriptionplan.map(v => ({ ...v, price: this.facilityInfo.price }))
