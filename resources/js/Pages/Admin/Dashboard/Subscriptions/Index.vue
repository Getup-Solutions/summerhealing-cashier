<template>
    ...
    <TableLayout>
        ...
        <TableNew :data="subscriptions.data" :tableContent="[
            ...
            { heading: 'Subscription', type: 'text', value: 'name' },
            { heading: 'User Name', type: 'relation', values: ['user', 'full_name'] },
            { heading: 'Expires at', type: 'text', value: 'end_date' },
            { heading: 'Status', type: 'text', value: 'status' },
