        ...
        <template #body>
            <div class="grid md:grid-cols-2 gap-6 gap-y-4">
                <div class="col-span-2 grid md:grid-cols-2 gap-6 gap-y-4">
                    ...
                    <FormSimpleInput :label="'Title'" :name="'title'" :type="'text'" v-model="courseInfo.title"
                        @change="nameToSlug()" :error="errors.title">
                    </FormSimpleInput>
                    <FormSimpleInput :label="'Slug'" :name="'slug'" :type="'text'" v-model="courseInfo.slug"
                        @change="createSlug()" :error="errors.slug">

                    </FormSimpleInput>
                    <FormSelect :label="'Age group'" :name="'agegroup'" v-model="courseInfo.agegroup_id"
                        :error="errors.agegroup_id" :optionsArray="agegroups" :optionName="'title'" :optionValue="'id'">
                    </FormSelect>
                    <FormSelect :label="'Level'" :name="'level'" v-model="courseInfo.level" :error="errors.level"
                        :optionsArray="levels" :optionName="'name'" :optionValue="'value'">
                    </FormSelect>
                    <FormSimpleInput :label="'Video embeded URL'" :name="'video_url'" :type="'text'"
                        v-model="courseInfo.video_url" :error="errors.video_url">
                    </FormSimpleInput>
                    <div class="col-span-2">
                        <FormTextArea :label="'Excerpt'" :name="'excerpt'" v-model="courseInfo.excerpt"
                            :error="errors.description">
                        </FormTextArea>
                    </div>
                    <div class="col-span-2">
                        <FormTextArea :label="'Description'" :name="'description'" v-model="courseInfo.description"
                            :error="errors.description">
                        </FormTextArea>
                    </div>

                    <div class=" col-span-2">
                        <FormFileUploadSingle @fileChange="(file) => (courseInfo.thumbnail = file[0])" :label="'Thumbnail'"
                            :oldImageLink="course.thumbnail_url" :rounded="false" :name="'thumbnail'" :hideInputBox="true"
            ...
            <FormCheckBox :label="'Published'" :name="'published'" :checked="true" v-model="courseInfo.published"
...
export default {
props: ["errors","course", "agegroups", "levels", "trainers", "subscriptionplansPrices","subscriptionplansSelected","trainersSelected"],
data() {
    return {
        courseInfo: Object.assign(this.course, {subscriptionplansSelected: this.subscriptionplansSelected, trainers: this.trainersSelected}),
        deleteId: false,
        subscriptionplanPricing: this.course.selectedSubscriptionplansWithPrice
    };
},
...
mounted() {
    ...
    this.courseInfo.published = true
},
methods: {
    nameToSlug(){
