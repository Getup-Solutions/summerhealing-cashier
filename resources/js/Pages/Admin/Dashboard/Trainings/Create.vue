<template>
    <!-- Modal content -->
    <Modal :modalHeadingText="'Create new Training'" :modalHeadingResetButton="true" :modalWidth="2">
        <template #body>
        ...
        <template #footer>
            <Button
                @click.prevent="createRequest({ url: '/admin/dashboard/trainings', data: trainingInfo, only: ['flash', 'errors'] })"
                :text="'Create Training'" :color="'blue'"></Button>
        </template>
    </Modal>
</template>
<script>
