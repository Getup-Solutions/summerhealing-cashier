          ...
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            ...
            >
              <DialogPanel class="pointer-events-auto w-screen max-w-md">
                <div class="flex h-full flex-col overflow-y-scroll bg-white dark:bg-sh_dark_blue shadow-xl">
                  <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                    ...
                    <div class="mt-8">
                      <div class="flow-root">
                        <p v-if="cartContent.length === 0" class="text-gray-500 dark:text-gray-300">
                          No items in the cart!
                        </p>
                        <ul
                          role="list"
                          class="-my-6 divide-y divide-gray-700"
                          :key="cartRefresh"
                        >
                          <li
                  ...
                  <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                    ...
                    >
                      <p>
                        ...
                        <button
                          type="button"
                          class="font-medium text-blue-600 dark:text-sh_yellow hover:dark:text-yellow-400 hover:text-blue-500 mr-2"
                          @click="open = false"
                        >
                          Continue Shopping
